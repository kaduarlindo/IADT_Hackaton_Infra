...
# Policy para acesso básico a Lambda
resource "aws_iam_role_policy_attachment" "lambda_basic_execution" {
  role       = aws_iam_role.lambda_execution_role.name
  policy_arn = "arn:aws:iam::aws:policy/service-role/AWSLambdaBasicExecutionRole"
}

# Policy para acesso a S3
...
# Policy para acesso a Secrets Manager
...
# Policy para acesso a X-Ray
resource "aws_iam_role_policy" "lambda_xray_write_access" {
  name = "${var.project_name}-lambda-xray-write-access"
  role = aws_iam_role.lambda_execution_role.id
...
# Policy para API Gateway invocar Lambda
...
resource "aws_iam_role_policy" "api_gateway_cloudwatch_logs" {
  name = "${var.project_name}-api-gateway-cloudwatch-logs"
  role = aws_iam_role.api_gateway_role.id
